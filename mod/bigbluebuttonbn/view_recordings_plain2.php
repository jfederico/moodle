...
use mod_bigbluebuttonbn\output\view_page_recordings_plain2;
...
$PAGE->set_url($instance->get_page_url('view_recordings_plain2'));
...
try {
    $renderedinfo = $renderer->render(new view_page_recordings_plain2($instance));
