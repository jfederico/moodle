...
Feature: The recording can be managed through the room page
  ...
  Scenario: I can rename the recording
    ...
    Then I should see "Recording 1"
    And I should see "Recording 2"
    When I click on "Recording 1" "link"
    When I rename the recording to "Recording with an updated name 1"
  ...
  Scenario: I can set a new description for this recording
    ...
    When I set the recording description to "This is a new recording description 1"
    And I press enter in the recording description input
