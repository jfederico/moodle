...
class settings {
    ...
    protected function add_locksettings_settings(): void {
        ...
        if ($this->admin->fulltree) {
            $this->add_settings_setting($lockingsetting, 'disablecam');
            $this->add_settings_setting($lockingsetting, 'disablemic');
            $this->add_settings_setting($lockingsetting, 'disableprivatechat');
            $this->add_settings_setting($lockingsetting, 'disablepublicchat');
            $this->add_settings_setting($lockingsetting, 'disablenote');
            $this->add_settings_setting($lockingsetting, 'hideuserlist');
            if ((boolean) setting_validator::section_lockonjoin_shown()) {
                $this->add_settings_setting($lockingsetting, 'lockonjoin');
            }
    ...
    /**
     * Helper function renders lock setting if the feature is enabled.
     *
     * @param admin_settingpage $lockingsetting The parent settingpage to add to
     * @param string $settingname
     */
    protected function add_settings_setting(admin_settingpage $lockingsetting, string $settingname): void {
        // Configuration for BigBlueButton.
        $item = new admin_setting_configcheckbox(
